...
?>
  ...
  <section id="hero" class="d-flex align-items-center">
    <div class="container text-center position-relative" data-aos="fade-in" data-aos-delay="200">
      <h1>Farmer's Portal - The Easy and Efficient Market of everyone...</h1>
...
<img src="img/pja1.jpg" style="width: 100%;">
          ...
          <div class="col-lg-6 pt-4 pt-lg-0" data-aos="fade-left" data-aos-delay="200">
            ...
            <ul>
              <li><i class="ri-check-double-line"></i> ‘FARMER'S PORTAL' is a model farmer management website application..</li>
              <li><i class="ri-check-double-line"></i> ‘FARMER'S PORTAL’ provides a concept of virtual agricultural trade to its users.</li>
